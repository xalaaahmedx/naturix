  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        heroTag: 'recommend_button',
        onPressed: () =>
            context.read<ShoppingListCubit>().recommendShoppingItems(),
            ...
            child: Row(
              ...
              children: [
                ...
                FloatingActionButton(
                  heroTag: 'add_button',
                  onPressed: () => context.read<ShoppingListCubit>().add(),
          ...
          BlocBuilder<ShoppingListCubit, ShoppingListState>(
            builder: (context, state) {
              return ListView.builder(
                  ...
                  shrinkWrap: true,
                  itemCount: context.read<ShoppingListCubit>().items.length,
                  itemBuilder: (context, index) {
                    return ItemCard(
                      recommendedItem:
                          context.read<ShoppingListCubit>().items[index],
                      onTap: () =>
                          context.read<ShoppingListCubit>().remove(index),
                    );
                  });
            },
          ),
            ...
            if (state is ShoppingListIsLoading) {
              ...
              return ListView(
                ...
                children: [
                  ...
                  ListView.builder(
                    physics: NeverScrollableScrollPhysics(),
                    itemCount: ShoppingListSuccess
                            .shoppingListResponse?.recommendations?.length ??
                        0,
                    shrinkWrap: true,
                    itemBuilder: (context, index) {
              ...
              return Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      "This ai assistant will help you find the items you could really want or need in the future ",
